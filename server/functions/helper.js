...
async function sendMailClient (payment){ 
    const mailOptions = {
        ...
        <div style=";text-decoration-style:initial;text-decoration-color:initial;font-size:1.3em;font-family:&quot;Open Sans Hebrew&quot;,serif;direction:rtl">
            ...
            <p style="margin:0px">טודלי הינו מותג תוכן המתמחה בפיתוח, עיצוב ושיווק תכנים משחקיים המבוססים על סיפורי הרפתקאות ודמיון,</p>
            <p style="margin:0px">אנו מזמינים אתכם להיכנס לעולמם של הטודלים ולגלות את סוד הקסם שלהם.</p>
            <p style="margin:0px">מספר ההזמנה שלכם לבירורים הינו:<span> 34343434</span>.</p>
